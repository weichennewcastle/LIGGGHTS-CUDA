...
void PairGranHookeCuda::allocate()
{
	...
	if(! allocated2)
	{
		...
		//todo: transfer Y,COR,FF,FRF here
		//make deriveContactModelParams in cuda kernel

		cuda->shared_data.pair.coeff1[0][0]=200000;
		cuda->shared_data.pair.coeff1[0][1]=NULL;
		cuda->shared_data.pair.coeff1[1][0]=50;
		cuda->shared_data.pair.coeff1[1][1]=NULL;
		cuda->shared_data.pair.coeff2[0][0]=0.5;
		cuda->shared_data.pair.coeff2[0][1]=1;
